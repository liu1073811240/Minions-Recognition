...
class Validate_Data(Dataset):
    ...
    def __init__(self, root, txt_path):  # 定义路径和数据标准化
        ...
        for line in f:  # 遍历训练集文件
            ...
            # print(self.files_name)  # [D:\PycharmProjects\2020-09-08-minions_reg\Dataset\Validate_Data\0.png,..]
...
# 数据标准化过程
validate_path = r"D:\PycharmProjects\2020-09-08-minions_reg\Dataset\Validate_Data"
txt_path = r"D:\PycharmProjects\2020-09-08-minions_reg\Target\validate_label.txt"
validate_data = Validate_Data(validate_path, txt_path)

# data = DataLoader(dataset=validate_data, batch_size=10, shuffle=True)
# #
